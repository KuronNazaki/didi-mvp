          ...
          <View className="bg-white p-4">
            <View className="flex-row items-end h-8">
              ...
              <View className="ml-auto flex-row items-center">
                <Star />
                <Text className="text-[#FFCC00]">{4.5}/5 </Text>
                <Text className="text-[#FFE580]">({402})</Text>
              </View>
            </View>
            <Text className="mt-3 text-[#8A8A8E]">
              Relaxed pick serving spring rolls, pho, banh mi & other Vietnamese
              staples, alongside beer.
            </Text>
